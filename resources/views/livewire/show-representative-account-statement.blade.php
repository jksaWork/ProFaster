            ...
            <div class="content-header-left col-md-6 col-12 mb-2">
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        {{ Breadcrumbs::render('representative.account.statement') }}
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <table class="table datatable table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $item->trans_sn ? $item->trans_sn : $item->transaction_id }}</td>
                                                <td>{{ $item->Date }}</td>
                                                <td>{{ $item->add}}</td>
                                                <td>{{ $item->dedection}}</td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th colspan="1">{{__('translation.current.balance')}} :
                                                    {{$representative_current_account_balance}}
                                                </th>
